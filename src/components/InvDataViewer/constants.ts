...
export const incomeStatementStructure: LabelData<IncomeStatement>[] = [
    ...
    },       
    {
        ...
        children: [
            ...
            {
                label: 'Diluted',
                value: data => data.WEIGHTED_AVERAGE_SHARES_OUTSTANDING_DILUTED,
                main: true
            }
        ]
    },       
        ...
        children: [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        value: data => data.DEFERRED_INCOME_TAXES_CURRENT_ASSETS
                    },
                    {
            ...
            },
            {
                ...
                children: [
                        ...
                        children: [
                            {
                                ...
                                value: data => data.PROPERTY_AND_EQUIPMENT_AT_COST,
                                children: [
                                    {
                                        label: 'Land',
                                    ...
                                    },
                                    {
                                        ...
                                        value: data => data.FIXTURES_AND_EQUIPMENT
                                    },
                                    {
                            ...
                            },
                            {
                                ...
                                value: data => data.GROSS_PROPERTY_PLANT_AND_EQUIPMENT
                            },
                            {
                    ...
                    {
                        label: 'Deferred income taxes',
                        value: data => data.DEFERRED_INCOME_TAXES_NON_CURRENT_ASSETS
                    },
                    {
                        label: 'Goodwill',
                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                value: data => data.CAPITAL_LEASES_CURRENT_LIABILITIES
                            },
                            {
                            ...
                            {
                                label: 'Deferred income taxes',
                                value: data => data.DEFERRED_INCOME_TAXES_CURRENT_LIABILITIES
                            },
                            {
                                label: 'Deferred revenues',
                                value: data => data.DEFERRED_REVENUES_CURRENT_LIABILITIES
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: data => data.EMPLOYEE_COMPENSATION_AND_BENEFITS
                            },
                            {
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                label: 'Capital leases',
                                value: data => data.CAPITAL_LEASES_NON_CURRENT_LIABILITIES
                            },
                            {
                                label: 'Deferred taxes liabilities',
                                value: data => data.DEFERRED_TAXES_LIABILITIES
                            },
                            {
                                label: 'Deferred revenues',
                                value: data => data.DEFERRED_REVENUES_NON_CURRENT_LIABILITIES
                            },
                            {
                                label: 'Minority interest',
                                value: data => data.MINORITY_INTEREST_NON_CURRENT_LIABILITIES
                            },
                            {
                                label: 'Pensions and other benefits',
                                value: data => data.PENSIONS_AND_OTHER_BENEFITS
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: data => data.OTHER_LONG_TERM_LIABILITIES
                            }
                        ]
                    }
                ]
                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                value: data => data.ADDITIONAL_PAID_IN_CAPITAL
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: data => data.ACCUMULATED_OTHER_COMPREHENSIVE_INCOME
                            }
                        ]
                    },
                    {
...
export const cashFlowStructure: LabelData<CashFlow>[] = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                value: data => data.PROVISION_FOR_DOUBTFUL_ACCOUNTS_AND_INVENTORY_OBSOLENCE
            },
            {
                label: 'Deferred income taxes',
            ...
            },
            {
                ...
                value: data => data.PREPAID_EXPENSES_DEFERRED_COSTS_AND_OTHER_CURRENT_ASSETS
            },
            {
                label: 'Accounts payable',
        ...
        children: [
            {
                ...
                value: data => data.INVESTMENT_IN_PROPERTY_PLANT_AND_EQUIPMENT
            },
            {
