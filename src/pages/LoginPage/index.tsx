        ...
        <div className='m-auto w-3'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className='flex flex-column gap-2 m-3'>
                    ...
                    <input  id='input-login' {...register("login", { required: true })} className='p-inputtext' />
                </div>
                <div className='flex flex-column gap-2 m-3'>
                    <label htmlFor="input-password">Password</label>
                    <input id='input-password' {...register("password", { required: true })} type='password' className='p-inputtext' />
                </div>
                <div>
                    {(errors.login || errors.password) && <span>Missing required fields</span>}
                </div>
                <div className='m-3 text-center'><button type="submit" className='p-button'>Sign in</button></div>
            </form>
        </div>
